...
We use the first \emph{Gaia} data release, combined with the ground-based spectroscopic surveys, to search for the origin of halo stars in the Solar neighborhood.
...
Here, we analyze a re-siumulation that includes those terms (all other parameters unchanged), which creates a more realistic distribution of metals in both the host galaxy (Wetzel et al., in prep.) and its satellites (Escala et al., in prep.).
